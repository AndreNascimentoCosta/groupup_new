...
/// Extending the `BuildContext` class with the `GUNavigatiorExtension` extension.
extension GUNavigatiorExtension on BuildContext {
  ...
  /// `pushNamed` is a function that takes a `GURouteName` and `arguments` as parameters and returns
  ...
  ///
  /// Args:
  ///   GURouteName (String): The name of the route to navigate to.
  ///   arguments (Object): This is the data that you want to pass to the next screen.
